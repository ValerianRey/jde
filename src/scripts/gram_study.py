"""
Runs a gram study (autogram engine) on a given dataset.
Usage:
  gram_study <dataset> <size> <n_lr> [--lr-csv-path=<str>] [--batch-size=<int>] [--epochs=<int>] [--optimizer=<str>] [--seed=<int>] [--wandb-mode=<str>] [--name=<str>]
...
from jde.solution_generators import generate_gram_solutions
...
def main() -> None:
    ...
    solutions = generate_gram_solutions(
