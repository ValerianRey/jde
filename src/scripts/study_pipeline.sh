...
uv run iwrm_study $1 faster_$2 22 --seed=$2 --wandb-mode=online --name="$1 $3 coarse $2"
...
uv run iwrm_study $1 faster_$2 50 --lr-csv-path="$1 $3 coarse $2/refined_lr_ranges.csv" --seed=$2 --wandb-mode=online --name="$1 $3 fine $2"
sleep 60  # Just to be sure that wandb had time to receive the data
